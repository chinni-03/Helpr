...
export default function NewUserScreen({ navigation }) {
  ...
  const handleProceed = async () => {
    ...
    if (commonPasswords.includes(password)) {
      Alert.alert('Common Password', 'This password is too common. Please choose a stronger, unique password.');
      return;
    }
  ...
  const readCommonPasswords = async () => {
    try {
        ...
        const asset = Asset.fromModule(require('../assets/CommonPasswords.txt')); // Adjust the path as necessary
